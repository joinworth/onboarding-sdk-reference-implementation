import ApplicantInfo from '@/components/demo/ApplicantInfo'
import BusinessInfo from '@/components/demo/BusinessInfo'
import { initialFormData } from '@/components/demo/constants'
import FormSection from '@/components/demo/FormSection'
import OwnerInfo from '@/components/demo/OwnerInfo'
import { convertFormValue } from '@/components/demo/utils'
...
const DemoForm = (): ReactElement => {
  ...
  return (
    <div className="min-h-screen bg-blue-950 py-12 px-6">
